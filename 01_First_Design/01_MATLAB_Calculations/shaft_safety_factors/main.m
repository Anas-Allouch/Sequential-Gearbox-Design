...
clear all
clc
file            = 'C:\Users\anasa\OneDrive\Desktop\Gearbox Project\Excel Files\Important\input shaft features.xlsx';
Moment_range    = 'F4:F21';
diam_range      = 'L4:L21';
notch_range     = 'M4:M21';
kt_range        = 'N4:N21';
...
clear all
clc
file            = 'C:\Users\anasa\OneDrive\Desktop\Gearbox Project\Excel Files\Important\output shaft features.xlsx';
Moment_range    = 'F4:F14';
diam_range      = 'L4:L14';
notch_range     = 'M4:M14';
kt_range        = 'N4:N14';
...
Tmax    = 450;
diam    = 37; % D = 40
notch   = 1.5; % relief groove with a radius of 1.5
kt      = 1.88;
kts     = 1.3;
flag    = 1;
n_SF    = SafetyFactors(Sut, Sy, Mmax, Tmax, diam, notch, kt, kts, flag)
Tmax    = 1457.1;
n_SF    = SafetyFactors(Sut, Sy, Mmax, Tmax, diam, notch, kt, kts, flag)